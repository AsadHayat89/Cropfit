...
class OrganicStoreScreen extends StatefulWidget {
  const OrganicStoreScreen({Key? key}) : super(key: key);

  @override
  State<OrganicStoreScreen> createState() => _OrganicStoreScreenState();
}

class _OrganicStoreScreenState extends State<OrganicStoreScreen> {
  @override
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> cropsStream = db.collection("crops").where('type', isEqualTo: 'Organic').where('deal',isEqualTo:'For Buyer').snapshots();
    return Scaffold(
      appBar: AppBar(
