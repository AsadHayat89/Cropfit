...
class OrganicCardScreen extends StatefulWidget {
  const OrganicCardScreen({Key? key}) : super(key: key);

  @override
  State<OrganicCardScreen> createState() => _OrganicCardScreenState();
}

class _OrganicCardScreenState extends State<OrganicCardScreen> {
  @override
