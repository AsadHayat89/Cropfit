...
class VeggiesStoreScreen extends StatefulWidget {
  const VeggiesStoreScreen({Key? key}) : super(key: key);

  @override
  State<VeggiesStoreScreen> createState() => _VeggiesStoreScreenState();
}

class _VeggiesStoreScreenState extends State<VeggiesStoreScreen> {
  @override
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> cropsStream =  db.collection("crops").where('type', isEqualTo: 'Vegetable').where('deal',isEqualTo:'For Buyer').snapshots();
