...
class FruitStoreScreen extends StatefulWidget {
  const FruitStoreScreen({Key? key}) : super(key: key);

  @override
  State<FruitStoreScreen> createState() => _FruitStoreScreenState();
}

class _FruitStoreScreenState extends State<FruitStoreScreen> {
  @override
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> cropsStream = db.collection("crops").where('type', isEqualTo: 'Fruit').where('deal',isEqualTo:'For Buyer').snapshots();
