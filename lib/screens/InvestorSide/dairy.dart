...
class DairyCardScreen extends StatefulWidget {
  const DairyCardScreen({Key? key}) : super(key: key);

  @override
  State<DairyCardScreen> createState() => _DairyCardScreenState();
}

class _DairyCardScreenState extends State<DairyCardScreen> {
  @override
