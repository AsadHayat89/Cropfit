...
class VegetablesCardScreen extends StatefulWidget {
  List<String> dataList;
   VegetablesCardScreen({Key? key,required this.dataList}) : super(key: key);

  @override
  State<VegetablesCardScreen> createState() => _VegetablesCardScreenState();
}

class _VegetablesCardScreenState extends State<VegetablesCardScreen> {
  @override
